...
public class SmoothFollow : MonoBehaviour 
{
	...
	public float posOffX = 10.0f;
	public float posOffY = -10.0f;
	public float posOffZ = 10.0f;
	...
	void LateUpdate ()
	{
		...
		Vector3 posOffsetXZ = new Vector3 (posOffX, posOffY, posOffZ).normalized;
		transform.position -= Vector3.Scale(posOffsetXZ, transform.forward);
